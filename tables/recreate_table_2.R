...
models <- c("setartree_lin_test", 
            "setartree_error_imp", 
            "setartree_both", 
            "setarforest_bagging_freq_10_random_tree_significance_random_significance_divider", 
            "setarforest_bagging_freq_10_random_tree_error_threshold", 
            "setarforest_bagging_freq_10_random_tree_significance_random_tree_error_threshold_random_significance_divider")

model_names <- c("Tree.Lin.Test", 
                 "Tree.Error.Red", 
...
print("Table 2 Mean msMAPE Errors")
mean_smape_errors

print("Table 2 Median msMAPE Errors")
median_smape_errors

print("Table 2 Mean MASE Errors")
mean_mase_errors

print("Table 2 Median MASE Errors")
median_mase_errors
